...
PYBIND11_MODULE(pyrat, m) {
    ...
    py::class_<Channel>(m, "Channel")
        ...
        .def("getPenetrationFactor", &Channel::getPenetrationFactor)
        .def("getShiftFactor", &Channel::getShiftFactor)
        .def("getPhaseShift", &Channel::getPhaseShift)
        .def("getWaveNumber", &Channel::getWaveNumber)
        .def("L", &Channel::L)
        .def("mass1", &Channel::mass1)
        .def("getWaveNumberSquared", &Channel::getWaveNumberSquared)
        .def("PhaseShift", &Channel::PhaseShift, py::arg("energy"), py::arg("l"), py::arg("entranceParticlePair"))
        .def("PenetrationFactor", &Channel::PenetrationFactor, py::arg("energy"), py::arg("l"), py::arg("entranceParticlePair"))
        .def("ShiftFactor", &Channel::ShiftFactor, py::arg("energy"), py::arg("l"), py::arg("entranceParticlePair"));
    ...
    py::class_<CompoundSystem>(m, "CompoundSystem")
        ...
        .def(py::init<const ParticlePair&, const std::vector<SpinGroup>&>(), py::arg("entranceParticlepair"), py::arg("spinGroups"))
